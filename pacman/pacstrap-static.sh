...
# NOTE: This script is distributed under GPLv2. See upstream license:
# https://github.com/archlinux/arch-install-scripts/blob/master/COPYING
...
if ! unshare --fork --pid pacman-static -r "$newroot" $pacmode "${pacman_args[@]}"; then
